...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-white sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item  {{ request()->is('rencanakegiatanuser', 'pelaksanaan') ? 'active' : '' }}">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-gradient-primary py-2 collapse-inner rounded">
            <a class="collapse-item text-white {{ request()->is('rencanakegiatanuser') ? 'active' : '' }}" href="/rencanakegiatanuser">Rencana Kegiatan</a>
            <a class="collapse-item text-white {{ request()->is('pelaksanaan') ? 'active' : '' }}" href="{{ route('pelaksanaan.index') }}">Pelaksanaan</a>
          </div>
        </div>
      </li>

      <li class="nav-item {{ request()->is('datamasteruser') ? 'active' : '' }}">
        <a class="nav-link text-primary" href="/datamasteruser?data=rencana">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="/profiluser">
                  <i class="fas fa-user fa-sm fa-fw mr-2"></i>
                  Profile
                </a>
                <a class="dropdown-item" href="/ubahpassworduser">
