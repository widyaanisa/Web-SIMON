...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-white sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item  {{ request()->is('rencanakegiatanadmin', 'pelaksanaan', 'jeniskegiatan') ? 'active' : '' }}">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-gradient-primary py-2 collapse-inner rounded">
            <a class="collapse-item text-white {{ request()->is('rencanakegiatanadmin') ? 'active' : '' }}" href="/rencanakegiatanadmin">Rencana Kegiatan</a>
            <a class="collapse-item text-white {{ request()->is('pelaksanaan') ? 'active' : '' }}" href="{{ route('pelaksanaan.index') }}">Pelaksanaan</a>
            <a class="collapse-item text-white {{ request()->is('jeniskegiatan') ? 'active' : '' }}" href="{{ route('jeniskegiatan.index') }}">
              Jenis Kegiatan
            </a>
          </div>
        </div>
      ...
      <li class="nav-item {{ request()->is('datamasteradmin') ? 'active' : '' }}">
        <a class="nav-link text-primary" href="/datamasteradmin?data=rencana">
          <i class="fas fa-fw fa-database text-primary"></i>
          <span>Data Master</span></a>
      </li>

      <li class="nav-item {{ request()->is('admin/users') ? 'active' : '' }}">
        <a class="nav-link text-primary" href="{{ route('manage-user-admin') }}">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="/ubahpasswordadmin">
