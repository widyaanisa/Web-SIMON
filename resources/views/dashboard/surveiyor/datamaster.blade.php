...
@section('content')
  <div class="container-fluid">
    @php
      $printUrl = '/datamastersyor/export?' . explode('?', url()->full())[1];
    @endphp
    ...
    <div class="card shadow mb-4">
      <div class="card-header">
        <form action="/datamastersyor" class="d-none d-sm-inline-block form-inline mr-auto navbar-search">
                ...
                <tbody>
                  <tr>
                    ...
                    {{-- <td>
                      ...
                      {{-- <form method="POST" style="display: inline" action="{{ route('surveiyor.rencanakegiatan.delete') }}">
                        @csrf
