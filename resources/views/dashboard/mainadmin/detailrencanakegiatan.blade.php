...
@section('content')
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      ...
      <form action="{{ route('mainadmin.rencanakegiatan.update') }}" method="POST" enctype="multipart/form-data">
        <div class="card-body">
          {{ csrf_field() }}
        ...
        <div class="card-footer text-right">
          <a href="/rencanakegiatanmainadmin" class="btn btn-secondary" data-dismiss="modal">Cancel</a>
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
              ...
              @foreach ($rencana->fileRencanaKegiatan as $key => $file)
                <tr>
                  ...
                  <td>
                    ...
                    <form method="POST" style="display: inline" action="{{ route('mainadmin.rencanakegiatan.removefile', $rencana->id_rencana) }}">
                      @csrf
        ...
        <form action="{{ route('mainadmin.rencanakegiatan.addfile', $rencana->id_rencana) }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="form-row">
