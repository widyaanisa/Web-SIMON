...
@section('content')
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      ...
      <form action="{{ route('user.rencanakegiatan.update') }}" method="POST" enctype="multipart/form-data">
        <div class="card-body">
          {{ csrf_field() }}
          ...
          <div class="form-row">
            ...
            <div class="value">
              <input value="{{ $rencana->bulan_tahun }}" id="edit-rk-bulan" class="form-control bg-white border-1 small mr-4 input-month" type="text" name="bulan_tahun">
            </div>
          </div>
        ...
        <div class="card-footer text-right">
          <a href="/rencanakegiatanuser" class="btn btn-secondary" data-dismiss="modal">Cancel</a>
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
              ...
              @foreach ($rencana->fileRencanaKegiatan as $key => $file)
                <tr>
                  ...
                  <td>
                    ...
                    <form method="POST" style="display: inline" action="{{ route('user.rencanakegiatan.removefile', $rencana->id_rencana) }}">
                      @csrf
        ...
        <form action="{{ route('user.rencanakegiatan.addfile', $rencana->id_rencana) }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="form-row">
