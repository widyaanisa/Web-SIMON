            ...
            @foreach ($rencanakegiatan as $rk)
              <tbody>
                <tr>
                  ...
                  <td>{{ $rk->personal }}</td>
                  {{-- <td>
                    <a href="{{ route('user.rencanakegiatan.detail', $rk->id_rencana) }}" class="btn btn-sm btn-outline-success mr-1 mb-1">
                      View
                    </a> --}}
                    ...
                    {{-- <form method="POST" style="display: inline" action="{{ route('user.rencanakegiatan.delete') }}">
                      @csrf
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="rencanakegiatanuser/create" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-row">
  ...
  <div class="modal fade" id="editrk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="rencanakegiatanuser/update" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
