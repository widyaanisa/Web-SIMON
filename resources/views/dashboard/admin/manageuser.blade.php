          ...
          {{-- <form method="POST" enctype="multipart/form-data" action="/mainadmin/users/import">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                ...
                <a class="btn btn-primary ml-1" href="/admin/users/export">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="{{ $role == 'admin' ? '/admin/users/import' : '/admin/users/export' }}">
                  @csrf
                  <div class="input-group">
                    <input required type="file" name="file" class="form-control bg-white border-1 small">
                    <div class="input-group-append">
