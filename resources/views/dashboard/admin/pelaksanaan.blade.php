...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <a class="btn btn-info add-new " href="#" data-toggle="modal" data-target="#formdatapelaksanaanModal"><i
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-sm btn-outline-primary mr-1 mb-1"><i
                                            class="fas fa-edit"></i>Edit</a>
                                    <a href="#" class="btn btn-sm btn-outline-danger mr-1 mb-1"><i
...
<div class="modal fade" id="formdatapelaksanaanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="value">
                            <select class="form-control bg-white border-1 small mr-4" placeholder="Pilih Data"
                                aria-label="select" name="jeniskegiatan">
                    ...
                    <div class="form-row">
                        ...
                        <div class="value">
                            <input  class="form-control bg-white border-1 small mr-4" type="text" name="nosprin">
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="value">
                            <select class="form-control bg-white border-1 small mr-4" placeholder="Pilih Data"
                                aria-label="select" name="personal">
                                <option value="datarencanakegiatan">Data Rencana Kegiatan</option>
                                <option value="datapelaksanaan">Data Pelaksanaan</option>
                            </select>
                        </div>
