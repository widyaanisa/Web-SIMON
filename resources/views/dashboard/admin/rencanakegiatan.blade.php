            ...
            @foreach ($rencanakegiatan as $rk)
              <tbody>
                <tr>
                  ...
                  <td>{{ $rk->personal }}</td>
                  <td>
                    <a href="{{ route('admin.rencanakegiatan.detail', $rk->id_rencana) }}" class="btn btn-sm btn-outline-success mr-1 mb-1">
                      View
                    </a>
                    ...
                    <form method="POST" style="display: inline" action="{{ route('admin.rencanakegiatan.delete') }}">
                      @csrf
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('admin.rencanakegiatan.create') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-row">
            ...
            <div class="form-row">
              ...
              <div id="wrapper-tentang" class="value">
                <div class="input-group js-input-file">
                  <input  type="file" id="tentang" class="form-control" name="tentang[]" multiple="true">
        ...
        <div class="modal-body">
          <form action="{{ route('admin.rencanakegiatan.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="name">Bulan - Tahun</div>
              <div class="value">
                <input pattern="\d{1,2}-\d{4}" id="edit-rk-bulan" class="form-control bg-white border-1 small mr-4 input-month" type="text" name="bulan_tahun">
              </div>
            </div>
            ...
            <div class="form-row">
              ...
              <div class="value">
                <div class="input-group js-input-file">
                  <input  id="edit-rk-tentang" type="file" id="tentang" class="form-control-file" name="tentang[]" multiple="true">
                </div>
                <div class="label--desc">Upload your PDF, JPG, JPEG, PNG or any other relevant file. Max
                  file size 50 MB</div>
              </div>
