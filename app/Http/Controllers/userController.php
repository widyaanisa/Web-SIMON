...
class userController extends Controller
{
	...
	public function homeuserfrontend()
	{
	...
	public function datamasterfrontend(Request $request)
	{
		...
		if ($data == 'rencana') {
			...
			return view('dashboard.user.datamaster', ["title" => "Data Master", "data" => $data, 'rencanakegiatan' => $rencanakegiatan]);
			...
			return view('dashboard.user.datamaster', ["title" => "Data Master", "data" => $data, 'daftarPelaksanaan' => $daftarPelaksanaan]);
		}
	}
	...
	{
		return view('dashboard.user.pelaksanaan', ["title" => "Data Pelaksanaan"]);
	}
	...
	public function rencanakegiatanfrontend()
	{
		...
		$rencankegiatan = RencanaKegiatan:: where('status', '=', 'user' ,)->get();
		$jeniskegiatan = JenisKegiatan::all();
		$users = User::where('nama_pengguna', \auth()->user()->nama_pengguna)->get();
		return view('dashboard.user.rencanakegiatan', ["title" => "Data Rencana Kegiatan"], compact('rencanakegiatan', 'jeniskegiatan', 'users'));
	}
	...
	public function rencanakegiatancreate(Request $request)
	{
		...
		return redirect()->route('user.rencanakegiatan')->with('success', ' Rencana Kegiatan baru berhasil dibuat.');
	}
	...
	public function rencanakegiatandetail($id)
	{
		...
		return \view('dashboard.user.detailrencanakegiatan', ['title' => 'Detail', 'rencana' => $rencana, 'jeniskegiatan' => $jeniskegiatan, 'users' => $users]);
	}
	...
	public function rencanakegiatandelete(Request $request)
	{
		...
		return redirect()->route('user.rencanakegiatan')->with('success', ' Rencana Kegiatan berhasil dihapus.');
	}
	...
	public function rencanakegiatanupdate(Request $request)
	{
		...
		return redirect()->route('user.rencanakegiatan')->with('success', ' Rencana Kegiatan berhasil diubah.');
	}
	...
	public function rencanakegiatanaddFile(Request $request, $id)
	{
		...
		return \redirect()->route('user.rencanakegiatan.detail', $id)->with('success', 'Successfully added new file');
	}
	...
	public function rencanakegiatanremoveFile(Request $request, $id)
	{
		...
		return \redirect()->route('user.rencanakegiatan.detail', $id)->with('success', 'Successfully deleted file');
	}
	...
	{
		return view('dashboard.user.editprofil', ["title" => "Edit Profil"]);
	}

	public function ubahpasswordfrontend()
	{
		return view('dashboard.user.ubahpassword', ["title" => "Change Password"]);
	}
	...
	public function changePassword(Request $request)
	{
		...
		return \redirect()->route('user.changepassword')->with('success', 'Successfully changed password');
	}
}
